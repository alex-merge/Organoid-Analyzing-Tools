...
class preprocessing():
    ...
    def load_from_trackmate(dirpath, rescaling = [1, 1, 1]):
        """
        Load the csv files that have been generated by Trackmate.
        The expected files are the tracks>spots csv.
        Returns a pandas dataframe containing coordinates for each spots.
        ...
        df = import_data.read_spots(dirpath, rescaling)
    ...
    def denoise_timelapse(df, img_dirpath, savepath = None,
        ...
        ----------
        df : pandas.DataFrame
            Dataframe from the load_from_trackmate method.
        img_dirpath : str
